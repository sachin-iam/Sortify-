...
class NotificationService {
  ...
  // Notification types
  sendNewEmailNotification(userId, emailData) {
  ...
  sendClassificationNotification(userId, classificationData) {
    return this.sendPushNotification(userId, {
      type: 'classification',
  ...
  sendBulkOperationNotification(userId, operationData) {
    return this.sendPushNotification(userId, {
      type: 'bulk_operation',
  ...
  sendSyncStatusNotification(userId, statusData) {
    return this.sendPushNotification(userId, {
      type: 'sync_status',
  ...
  sendSystemAlert(userId, alertData) {
    return this.sendPushNotification(userId, {
      type: 'system',
  ...
  setUserPreferences(userId, preferences) {
    this.userPreferences.set(userId, {
      ...
      notificationTypes: preferences.notificationTypes || ['new_email', 'classification', 'bulk_operation'],
  ...
  getUserPreferences(userId) {
    return this.userPreferences.get(userId) || {
      ...
      emailAlerts: false,
      notificationTypes: ['new_email', 'classification', 'bulk_operation'],
